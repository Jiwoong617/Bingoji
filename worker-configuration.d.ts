/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7ae6fba33805412c0ef569973e07d3a)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 
interface __BaseEnv_Env {
	ROOM_CREATE_RATE_LIMITER: RateLimit;
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173,https://jiwoong617.github.io";
	BINGOJI_ROOMS: DurableObjectNamespace<import("./worker/index").BingojiRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BingojiRoom";
	}
